...
const FriendsActivity = () => {
    ...
    const { user } = useUser();  // user == current user
        ...
        <div className="h-full bg-zinc-900 rounded-lg flex flex-col">
            ...
            <div className="p-4 flex justify-between items-center border-b border-zinc-800">
                <div className="flex items-center gap-2">
                    <Users className="shrink-0 size-5"/>
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="flex items-center gap-2">
                                            ...
                                            {isPlaying && <Music className="size-3.5 text-primary shrink-0"/>}
                                        </div>
...
// Login prompt to see friends activity for non-logged in users
const LoginPrompt = () => {
    return (
        <div className="h-full flex flex-col items-center justify-center p-6 text-center space-y-4">
            ...
            <div className="space-y-2 max-w-[250px]">
                <h3 className="text-lg font-semibold text-white">See What Friends Are Vibing To</h3>
                <p className="text-sm text-zinc-400">Login to discover music with your friends</p>
            </div>
        </div>
    );
};